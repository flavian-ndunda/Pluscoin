...
Copyright (c) 2018-2019 Pluscoin Developers
...
Setup
-----
After completing windows setup then run pluscoin-qt.
Alternatively you can run windows command line (cmd) in pluscoin program dir.
  cd daemon
  pluscoind
You would need to create a configuration file pluscoin.conf in the default
wallet directory. Grant access to pluscoind/pluscoin-qt in anti-virus and firewall
applications if necessary.

The software automatically finds other nodes to connect to.  You can
enable Universal Plug and Play (UPnP) with your router/firewall
or forward port 9901 (TCP) to your computer so you can receive
incoming connections.  Pluscoin works without incoming connections,
but allowing incoming connections helps the Pluscoin network.
...
pluscoind backupwallet <destination_backup_file>
